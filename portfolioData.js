...
export const educationHighlights = [
  {
    ...
    meta: "University College Cork · Graduate",
    description: "My MSc covered business performance, information systems, analytics, databases, digital governance and project management, all pointing toward the same goal: using technology to make things run better.",
