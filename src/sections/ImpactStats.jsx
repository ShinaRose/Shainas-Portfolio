        ...
        {impactStats.map((stat) => (
          <motion.div key={stat.label} variants={staggerItem} className="flex items-start gap-4 pt-6 first:pt-0 sm:px-6 sm:pt-0 first:sm:pl-0">
            <motion.div
              ...
              className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-rose-100 to-purple-100 text-rose-800"
            >
              <Icon name={stat.icon} className="h-5 w-5" />
            </motion.div>
            <div>
              <p className="bg-gradient-to-br from-slate-950 to-rose-900 bg-clip-text text-3xl font-extrabold tracking-tight text-transparent">
