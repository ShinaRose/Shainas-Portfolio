    ...
    <section id="about" className="scroll-mt-28 border-y border-rose-100 bg-white">
      <div className="mx-auto grid max-w-6xl gap-10 px-6 py-16 md:grid-cols-[0.86fr_1.14fr] md:items-start md:py-20">
        <SectionHeading
          ...
          description="I'm currently studying Information Systems for Business Performance at UCC, building skills across business decision support, systems analysis, databases, analytics, digital governance and IT project management. What I'm most drawn to is the practical side of it — taking messy data or a clunky process and making it clearer for the people who have to use it every day."
        />
