...
export default function Portfolio() {
  return (
    <MotionConfig reducedMotion="user">
      <div className="min-h-screen scroll-smooth bg-[radial-gradient(ellipse_900px_600px_at_10%_0%,#ffc9dd_0%,transparent_55%),radial-gradient(ellipse_800px_600px_at_100%_15%,#e4ccff_0%,transparent_55%),radial-gradient(ellipse_700px_500px_at_50%_100%,#ffdca8_0%,transparent_50%),#fdf0f4] text-slate-900 selection:bg-rose-200 selection:text-rose-950">
